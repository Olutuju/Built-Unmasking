---
title: "Building Work Around Flares: Lessons From Downtown Austin Operators"
date: 2026-06-28
description: "You can't schedule a flare. You can build a business that survives one. Here's how experienced founders in Austin design their companies to bend on the bad days."
place: "Downtown Austin"
tags: [downtown-austin, chronic-illness, entrepreneurship, energy-management]
takeaways:
  - "Design your business assuming flares will happen, because they will."
  - "Documentation, buffers, and a capable second person turn a flare from a crisis into a Tuesday."
  - "Batch high-stakes work into your reliable windows and protect them fiercely."
faq:
  - q: "How do you run a business when you have unpredictable flares?"
    a: "Build the business to survive your absence: document core processes, keep buffers in every deadline, batch critical work into your reliable energy windows, and develop a second person who can cover. The goal is a company that bends when you flare instead of breaking."
  - q: "Should you tell clients about a chronic illness?"
    a: "You rarely need to disclose a diagnosis. Set expectations through systems instead, clear timelines with built-in buffers, backup contacts, and reliable communication. Clients care that the work lands, not why a specific day was hard."
---

You cannot schedule a flare. It doesn't check your calendar, it doesn't care about the launch, and it will not negotiate. So the goal is not to prevent the unpreventable. The goal is to build a business that treats a flare as a survivable event, a Tuesday, not a catastrophe. Here's what I've learned from other operators in Austin who've done it.
...
- **A capable second.** The single most important hire is the person who can keep the lights on when you can't. [Delegate before the flare](/blog/delegation-when-you-cant-do-it-all-austin-founder/), not during it.
