---
title: "Why 'You Look Fine' Hits Different for Black Women"
date: 2026-07-10
description: "'You look fine' is a heavy sentence for any accomplished woman managing an invisible difference. For Black women in Austin, there's an extra layer under it: strength gets mistaken for the absence of a problem."
place: "Downtown Austin"
tags: [austin, women-founders, black-women, chronic-illness, community]
takeaways:
  - "The 'strong Black woman' script reads endurance as identity, not as a sign something needs attention, which makes disclosure even less likely to land."
  - "The pattern isn't a feeling. Bias in pain assessment and outcomes for Black women is documented, not anecdotal."
  - "A room that already knows this doesn't need to be convinced first. That's the whole difference."
faq:
  - q: "Why do Black women's health concerns get dismissed more often?"
  ...
  - q: "Does Built & Unseen have programming specific to Black women?"
...
"You look fine" is already a heavy sentence. I've written about [how looking successful makes people believe you less, not more](/blog/successful-so-they-assume-youre-fine-austin/). For Black women I've talked to in this room, there's a layer under that sentence that I don't carry the same way, and I want to name it instead of flattening everyone's experience into one story.
...
## This isn't a feeling, it's a documented pattern

I don't want to leave this as an impression, because it isn't one. Research on pain assessment has repeatedly found that clinicians and observers underrate Black patients' pain relative to identical reports from white patients, some of it tied to false beliefs about biological differences between Black and white bodies that have no basis in fact. [Harvard Business Review](https://hbr.org/) has covered the workplace version of the same bias: Black women are simultaneously expected to project more resilience and given less benefit of the doubt when something's actually wrong. Two separate systems, medical and professional, running the same discount on the same person at the same time.
